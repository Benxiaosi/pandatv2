package com.example.pandatv.titleactivity.wo.zhuce.fragment;
...
import com.example.pandatv.titleactivity.wo.zhuce.fragment.base.BaseFragment;
...
import com.example.pandatv.titleactivity.wo.zhuce.fragment.view.XieYiActivity;
...
//import com.example.pandatv.untils.handler.HandlerListener;
//import com.example.pandatv.untils.handler.HandlerMessage;
//import com.example.pandatv.untils.handler.XjlHandler;

public class ShoujiFragment extends BaseFragment implements View.OnFocusChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_shouji, container, false);
        initView();
        return view;
    }
...
//                    UserManager.get.saveNickName(mNickName);
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                case R.id.personal_reg_xieyi_view:
                    Intent xieIntent = new Intent(getActivity(), XieYiActivity.class);
